...
Private Sub Display()
    ...
    If Delta >= MinDelta Then
        ...
        i = myDigits - 1
        With pcDigit(i)
            BitBlt .hDC, myExtraX \ 2 + myPosnX, myPosnY, CharWidth, BoxHeight, pcSource.hDC, 0, (Digit + Roll) * BoxHeight, CopySrc
            .Refresh
        End With 'PCDIGIT(I)
...
Public Property Set Font(ByVal nwFont As Font)
  ...
  Dim Dgt As String * 1
    ...
    For i = 0 To myDigits - 1 'prepare pcDigit's
        ...
        End With 'PCDIGIT(I)
    Next i
    MinDelta = 1 / BoxHeight 'skips Display if Delta is less
...
':) Ulli's VB Code Formatter V2.23.17 (2008-Jan-22 22:40)  Decl: 29  Code: 337  Total: 366 Lines
':) CommentOnly: 5 (1,4%)  Commented: 32 (8,7%)  Empty: 84 (23%)  Max Logic Depth: 5
